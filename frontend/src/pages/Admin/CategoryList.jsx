...
const CategoryList = () => {
    ...
    return (
        <div className="ml-[10rem] flex flex-col md:flex-row sm:flex-row">
            {/* <AdminMenu /> */}
                ...
                <div className="flex flex-wrap">
                    {categories?.map((category) => (
                        <div key={category._id}>
                            <button 
                                className=" bg-white hover:text-white py-2 px-4 border m-3 border-teal-500 text-teal-500 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50"
                                onClick={()=> {{
