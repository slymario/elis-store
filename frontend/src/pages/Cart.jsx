    ...
    return (
        <>
            <div className="container flex justify-around items-start flex-wrap mx-auto mt-8">
                {cartItems.length ===0 ? (
                    <div>Your cart is empty. . . <Link to='/shop' className='text-teal-500 hover:underline'>Go To Shop</Link></div>
                ) : (
                    <>
                        <div className="flex flex-col w-[80%]">
                            <h1 className="text-2xl font-semibold underline text-center mb-4">SHOPPING CART</h1>

                            {cartItems.map((item) => (
                                <div key={item._id} className="flex items-center mt-[2rem] mb-[1rem] pb-2">
                                    ...
                                    <div className="">
                                        ...
                                        >
                                            <FaTrash className="ml-[1rem] mt-[rem]" />
                                        </button>
                                    </div>
                                </div>
                            ))}
